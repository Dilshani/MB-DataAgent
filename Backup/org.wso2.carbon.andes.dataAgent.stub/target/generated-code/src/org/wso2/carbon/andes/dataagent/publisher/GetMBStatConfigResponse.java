 ...
 */
            ...
            /**
            *  GetMBStatConfigResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMBStatConfigResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://publisher.dataAgent.andes.carbon.wso2.org",
                "getMBStatConfigResponse",
                "ns6");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMBStatConfigResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMBStatConfigResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetMBStatConfigResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMBStatConfigResponse object =
                new GetMBStatConfigResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMBStatConfigResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMBStatConfigResponse)org.wso2.carbon.andes.dataagent.publisher.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
