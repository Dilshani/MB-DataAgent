        ...
        <div id="workArea">
            ...
            <form action="/carbon/publisher/dataAgentServlet" method="POST">
                <table class="styledLeft" style="width: 20%">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="5">Enable Publishertt</td>
                ...
                <div id="toggle">
                    ...
                    <table class="styledLeft" style="width: 100%" id="transport_table">
                        ...
                        <tr>
                            <td colspan="3">Message</td><td>
                            <input type="checkbox" id="message_stat_check" name="message_stat_check" value="true"/></td>
                            <td colspan="3">System</td><td>
                            <input type="checkbox" id="system_stat_check" name="system_stat_check" value="true"/></td>
                            <td colspan="3">MB</td><td>
                            <input type="checkbox" id="MB_stat_check" name="MB_stat_check" value="true"/></td>

                        </tr>

                    </table>
                    <tr>
                        <td colspan="12" class="buttonRow"><input type="submit" class="button" id="saveButton"
                                                                  name="saveButton"
                                                                  value="<fmt:message key="save"/>"
                                                                  onclick=""/>
                        </td>
                        <input type="hidden" name="publisher_name" value="BAM"/>
                    </tr>
