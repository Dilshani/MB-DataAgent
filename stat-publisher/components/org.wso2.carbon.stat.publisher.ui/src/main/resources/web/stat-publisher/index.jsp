...
<fmt:bundle basename="org.wso2.carbon.stat.publisher.ui.i18n.Resources">
   ...
   %>
    ...
    <div id="middle">
        ...
        <div id="workArea">
            <form id="details_form" action="/carbon/stat-publisher/statConfigurationServlet" method="POST" onsubmit="return DoValidation();">
                    ...
                    <table class="styledLeft" style="width: 100%" id="authentication_table">
                        ...
                        <tr>
                            <td class="formRaw"><fmt:message key="password"/><span
                                    class="required">*</span></td>
                            <td>&nbsp<input type="password" id="password" name="password" value="<%=get_password_value%>"/></td>
                        </tr>
                    </table>
