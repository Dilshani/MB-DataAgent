 ...
 */
            ...
            /**
            *  GetURLValidation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetURLValidation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getURLValidation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getURLValidation",
    ...
    public static class Factory{
        ...
        */
        public static GetURLValidation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetURLValidation object =
                new GetURLValidation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getURLValidation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetURLValidation)org.wso2.carbon.andes.dataagent.publisher.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
