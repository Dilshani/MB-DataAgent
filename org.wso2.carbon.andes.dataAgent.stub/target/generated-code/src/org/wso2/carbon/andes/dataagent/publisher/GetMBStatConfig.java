 ...
 */
            ...
            /**
            *  GetMBStatConfig bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMBStatConfig
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMBStatConfig",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMBStatConfig",
    ...
    public static class Factory{
        ...
        */
        public static GetMBStatConfig parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMBStatConfig object =
                new GetMBStatConfig();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMBStatConfig".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMBStatConfig)org.wso2.carbon.andes.dataagent.publisher.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
