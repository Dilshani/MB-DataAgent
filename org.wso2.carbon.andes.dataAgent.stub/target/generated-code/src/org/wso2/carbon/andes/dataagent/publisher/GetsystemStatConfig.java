 ...
 */
            ...
            /**
            *  GetsystemStatConfig bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetsystemStatConfig
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getsystemStatConfig",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getsystemStatConfig",
    ...
    public static class Factory{
        ...
        */
        public static GetsystemStatConfig parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetsystemStatConfig object =
                new GetsystemStatConfig();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getsystemStatConfig".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetsystemStatConfig)org.wso2.carbon.andes.dataagent.publisher.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
